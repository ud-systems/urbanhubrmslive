-- Database Optimization Script for Leads UrbanHub (SAFE VERSION)
-- This script only creates indexes for columns that definitely exist
-- Run this in your Supabase SQL Editor

-- =============================================
-- PERFORMANCE INDEXES (SAFE - ONLY KNOWN COLUMNS)
-- =============================================

-- Leads table indexes (based on TypeScript types)
...
-- Students table indexes (based on TypeScript types)
...
-- Studios table indexes (based on TypeScript types)
...
-- Studio occupancy view (simplified - no checkout column)
